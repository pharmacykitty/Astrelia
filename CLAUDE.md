...
- **Phase 4 (first test ✅):** Live AR "point at the sky" view — Sun, Moon, Sirius rendered as nodes where they actually are. Next: full star catalog, constellations, camera passthrough, polish.
